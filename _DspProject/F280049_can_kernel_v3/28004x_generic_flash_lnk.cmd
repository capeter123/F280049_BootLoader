...
PAGE 0 :
   ...
   /* Flash sectors */
   /* BANK 0 */
   FLASH_BANK0_SEC0_2  : origin = 0x080002, length = 0x002FFC	/* CAN Boot Loader,  on-chip Flash */
   FLASH_BANK0_DFU	   : origin = 0x082FFE, length = 0x000002   /* DFU Key */
...
SECTIONS
{
   ...
   .text            : >> FLASH_BANK0_SEC0_2,   PAGE = 0, ALIGN(4)
   .cinit           : > FLASH_BANK0_SEC0_2,     PAGE = 0, ALIGN(4)
   .switch          : > FLASH_BANK0_SEC0_2,     PAGE = 0, ALIGN(4)
...
//#else
   .pinit           : > FLASH_BANK0_SEC0_2,       PAGE = 0,       ALIGN(4)
   .ebss            : > RAMLS5,       PAGE = 1
   .esysmem         : > RAMLS5,       PAGE = 1
   .cio             : > RAMLS0,       PAGE = 0
   .econst          : > FLASH_BANK0_SEC0_2,    PAGE = 0, ALIGN(4)
//#endif
...
//                      PAGE = 0, ALIGN(4)
//#else
   .TI.ramfunc      : LOAD = FLASH_BANK0_SEC0_2,
