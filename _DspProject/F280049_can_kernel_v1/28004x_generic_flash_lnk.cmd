...
PAGE 0 :
   ...
   BEGIN           	: origin = 0x09B000, length = 0x000002
   ...
   // CAN Boot Program Area
   // FLASH_BANK1_SEC11 : origin = 0x09B002, length = 0x000FFE	/* on-chip Flash */
   //FLASH_BANK1_SEC12 : origin = 0x09C000, length = 0x001000	/* on-chip Flash */
   //FLASH_BANK1_SEC13 : origin = 0x09D000, length = 0x001000	/* on-chip Flash */
   //FLASH_BANK1_SEC14 : origin = 0x09E000, length = 0x001000	/* on-chip Flash */
   //FLASH_BANK1_SEC15 : origin = 0x09F000, length = 0x000FF0	/* on-chip Flash */
   FLASH_BANK1_SEC11_15 : origin = 0x09B002, length = 0x004FFE	/* on-chip Flash */
...
SECTIONS
{
   ...
   .text            : >> FLASH_BANK1_SEC11_15,   PAGE = 0, ALIGN(4)
   .cinit           : > FLASH_BANK1_SEC11_15,     PAGE = 0, ALIGN(4)
   .switch          : > FLASH_BANK1_SEC11_15,     PAGE = 0, ALIGN(4)
...
//#else
   .pinit           : > FLASH_BANK1_SEC11_15,       PAGE = 0,       ALIGN(4)
   .ebss            : > RAMLS5,       PAGE = 1
   .esysmem         : > RAMLS5,       PAGE = 1
   .cio             : > RAMLS0,       PAGE = 0
   .econst          : > FLASH_BANK1_SEC11_15,    PAGE = 0, ALIGN(4)
//#endif
...
//                      PAGE = 0, ALIGN(4)
//#else
   .TI.ramfunc      : LOAD = FLASH_BANK1_SEC11_15,
