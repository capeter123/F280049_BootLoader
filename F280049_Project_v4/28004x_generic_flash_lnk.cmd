...
PAGE 0 :
   ...
   /* Flash sectors */
   /* BANK 0 */
   FLASH_BANK0_SEC0_2  : origin = 0x080002, length = 0x002FFE	/* CAN Boot Loader,  on-chip Flash */
   ...
   FLASH_BANK1_SEC15 : origin = 0x09F000, length = 0x000FF0	/* on-chip Flash, FW Key Block(2Bytes) */
...
SECTIONS
{
   ...
   .text            : >> FLASH_BANK1_SEC0 | FLASH_BANK1_SEC1 | FLASH_BANK1_SEC2,   PAGE = 0, ALIGN(4)
   .cinit           : > FLASH_BANK1_SEC0,     PAGE = 0, ALIGN(4)
   .switch          : > FLASH_BANK1_SEC0,     PAGE = 0, ALIGN(4)
   .reset           : > RESET,     PAGE = 0, TYPE = DSECT /* not used, */
   .stack           : > RAMM1,     PAGE = 1
   .pinit           : > FLASH_BANK1_SEC0,       PAGE = 0,       ALIGN(4)
   .ebss            : > RAMLS5,       PAGE = 1
   .esysmem         : > RAMLS5,       PAGE = 1
   .cio             : > RAMLS0,       PAGE = 0
   .econst          : > FLASH_BANK1_SEC0,    PAGE = 0, ALIGN(4)

   ramgs0           : > RAMGS0,    PAGE = 1
   ramgs1           : > RAMGS1,    PAGE = 1

   .TI.ramfunc      : LOAD = FLASH_BANK1_SEC0,
